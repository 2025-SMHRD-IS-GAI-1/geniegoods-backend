...
public class UserRestController {
	...
	public ResponseEntity<Map<String, Object>> checkNicknameDuplicate(@RequestParam("nickname") String nickname,
	...
	public ResponseEntity<NickCheckResponseDTO> updateNickname(@RequestParam("nickname") String newNickname,
			@AuthenticationPrincipal UserEntity currentUser) {
